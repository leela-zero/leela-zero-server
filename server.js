...
app.get('/',  asyncMiddleware( async (req, res, next) => {
    ...
    Promise.all([
        ...
        page += "<br>Network 1e2b85cf0 is best_v1 tested as a reference point. It isn't a normal LZ network. Not a bug.<br>\n";
        ...
        page += "2018-01-19 <a href=\"https://github.com/gcp/leela-zero/releases\">Leela Zero 0.11 + AutoGTP v13</a>.<br>";
